...
def kmeans_aspect_ratios(bboxes, kmeans_max_iter, num_aspect_ratios):
  ...
  #print(np.sqrt(bboxes.prod(axis=1, keepdims=True)))
...
DATASET_FILE = 'train_data.csv'
#DATASET_FILE = '../../../../datasets/occupancy_management_dataset_v2/annotations.csv'
...
for l in data:
    ...
    if xmin != 0 and xmax != 0 and ymin != 0 and ymax != 0 :
      bboxes.append([(xmax-xmin)/width,(ymax-ymin)/height])
